...
async function main() {
 try{
      ...
      const rejectUnauthorized = process.env.rejectUnauthorized || false;
      ...
      let info = await transporter.sendMail({
        from: emailUser,
        to: "eng.massoud@hotmail.com,ondrej.ilek@ternologic.com,ahmad.herzallah@ternologic.com", // list of receivers
        subject: "Hello", // Subject line
        text: "Hello world?", // plain text body
        html:`<!-- #######  YAY, I AM THE SOURCE EDITOR! #########-->
        <h1 style="color: #5e9ca0;">Are you Ready for your virtual life?</h1>
